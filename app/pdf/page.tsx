  ...
  return (
    ...
    >
      <div className="overflow-hidden leading-normal text-black">
            ...
            <div className="grow">
              <span className="flex items-center space-x-1">
                <span
                  ...
                  style={{ width: '14px', height: '14px', color: '#8675A9' }}
                ></span>{' '}
              ...
              <span className="flex items-center">
                ...
                <span>
                  {data?.location ||
                    '3 Ghim Moh Road #10-278 Singapore 270003.'}
                </span>
              ...
              <a
                ...
                href={
                  data?.linkedIn ||
                  'https://www.linkedin.com/in/ng-chun-liang-09142528a'
                }
                target="_blank"
              >
                <span
        ...
        <div className="flex px-12 space-x-3 avoid-page-break">
          <div
            className="py-3 w-1/4 font-semibold uppercase border-t-2 shrink-0 border-subtle"
            style={{ color: '#8675A9' }}
          >
            Achievements
          </div>
          <div className="py-3 border-t-2 grow border-subtle">
            <ul className="pl-4 mt-1 list-disc justify-text">
              <li>
                Coordinated international business trips to Abu Dhabi, Saudi
                Arabia, and Thailand, delivering technical product
                demonstrations and supporting key client engagements. Led and
                executed on-site software deployment and optimized system
                performance based on customer insights, ensuring a high-quality
                user experience.
              </li>
              <li>
                Spearheaded the research and development of an AI-based image
                recognition model, and successfully integrated it with our
                company’s software solution, contributing to the enhancement of
                security systems for ICA at Woodlands Checkpoint.
              </li>
            </ul>
          </div>
        </div>
        <div className="px-12">
              ...
              <div className="grow">
                ...
                <ul className="pl-4 mt-1 list-disc justify-text">
                  <li>
                    ...
                    captured by our proprietary under-vehicle surveillance
                    systems, ensuring high-quality imaging for security
                    inspections.
                  </li>
                  <li>
                    Conceived and implemented new software designs and features
                    to modernise our application, thus improving user experience
          ...
          <div className="flex pb-3 space-x-3 avoid-page-break">
            ...
            <div className="grow">
              ...
              <ul className="pl-4 mt-1 list-disc justify-text">
                ...
                <li>
                  Ensured the final web pages adhered strictly to the client’s
                  design specifications, paying meticulous attention to details
                  such as typography, colour schemes, and layout alignment.
                </li>
              </ul>
            </div>
          </div>
          <div className="flex pb-3 space-x-3 avoid-page-break">
            ...
            <div className="grow">
              <div className="text-base" style={{ color: '#8675A9' }}>
                <span className="font-semibold">Database Administrator</span>
                <br />
              ...
              <ul className="pl-4 mt-1 list-disc justify-text">
                ...
                <li>
                  Assisted in managing and organising product information within
                  the company’s database, ensuring efficient data storage and
                  retrieval.
                </li>
              </ul>
            </div>
        ...
        <div className="px-12">
          ...
          <div className="flex pb-3 space-x-3 avoid-page-break">
            <div className="w-1/4 shrink-0 text-subtle">
              Singapore <br /> 04/2024 – 04/2024
            </div>
            <div className="grow">
              <div className="text-base" style={{ color: '#8675A9' }}>
                <span className="font-semibold">
                  Basic Ionising Radiation Safety (Industrial Radiography) For
                  R1 Certificate{' '}
                </span>
                <br />
          ...
          <div className="flex pb-3 space-x-3 avoid-page-break">
            <div className="w-1/4 shrink-0 text-subtle">
              Online <br /> 02/2023 – 03/2023
            </div>
            <div className="grow">
              <div className="text-base" style={{ color: '#8675A9' }}>
                <span className="font-semibold">HUAWEI HCIA-AI</span>
                <br />
                Huawei
              </div>
            </div>
          ...
          <div className="flex pb-3 space-x-3 avoid-page-break">
            <div className="w-1/4 shrink-0 text-subtle">
              Malacca, Malaysia <br /> 11/2020 – 01/2023
            </div>
            <div className="grow">
              <div className="text-base" style={{ color: '#8675A9' }}>
                <span className="font-semibold">
          ...
          <div className="flex pb-3 space-x-3 avoid-page-break">
            <div className="w-1/4 shrink-0 text-subtle">
              Malacca, Malaysia <br /> 07/2018 – 10/2020
            </div>
            <div className="grow">
              <div className="text-base" style={{ color: '#8675A9' }}>
                <span className="font-semibold">
          ...
          <div className="flex pb-3 space-x-3 avoid-page-break">
            <div className="w-1/4 shrink-0 text-subtle">
              Batu Pahat, Malaysia <br /> 01/2013 – 12/2017
            </div>
            <div className="grow">
              <div className="text-base" style={{ color: '#8675A9' }}>
                <span className="font-semibold">
                ...
                <br />
                Sekolah Menengah Kebangsaan (SMK) Munshi Sulaiman
              </div>
              <ul className="pl-4 mt-1 list-disc">
      ...
      <div className="flex px-12 space-x-3 avoid-page-break">
        ...
        <div className="py-3 border-t-2 grow border-subtle">
          <div className="flex flex-wrap -mt-3">
            <div className="pr-6 flex flex-wrap pt-3 w-1/2">
              <span className="mr-1 grow">English</span>
              <span className="text-subtle">Advanced</span>
            ...
            <div className="pl-6 flex flex-wrap pt-3 w-1/2">
              <span className="mr-1 grow">Chinese</span>
            ...
            <div className="pr-6 flex flex-wrap pt-3 w-1/2">
              <span className="mr-1 grow">Malay</span>
              <span className="text-subtle">Advanced</span>
              <div className="flex mt-1 space-x-1 w-full">
                <span
                  style={{ backgroundColor: '#8675A9' }}
