        ...
        <div>
          <div className="relative px-12 mb-3 text-2xl font-semibold" style={{ color: "#8675A9" }}>
            ...
            <div className="flex items-center">
              ...
              {data?.profilepic && <img src={data.profilepic} className="absolute right-12"
              ...
              style={{ width: "14px", height: "14px", color: "#8675A9" }}></span> <span
                className="no-underline">{data?.email || "ngchunliangy@gmail.com"}</span></span><span
                  className="flex items-center space-x-1"><span className="jlu-icon jlu-icon_call"
                    style={{ width: "14px", height: "14px", color: "#8675A9" }}></span> <span className="no-underline">{data?.contact || "+65 8433 2042"}</span></span><span className="flex items-center space-x-1"><span
                      className="jlu-icon jlu-icon_location_on mr-1"
                      style={{ width: "14px", height: "14px", color: "#8675A9" }}></span><span className="no-underline">{data?.location || "3 Ghim Moh Road #10-278 Singapore 270003."}</span><span style={{ display: "none" }}>,
            ...
            <div className="flex pb-3 space-x-3 avoid-page-break">
              ...
              <div className="grow">
                ...
                <ul className="pl-4 mt-1 list-disc">
                  <li>CGPA: 3.87 (First Class Honours)</li>
                </ul>
              </div>
            </div>
            <div className="flex pb-3 space-x-3 avoid-page-break">
