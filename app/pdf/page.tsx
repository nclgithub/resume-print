...
export default function PDF() {
  return (
    <div className="flex">
      <div className="text-sm leading-tight bg-white transition-all origin-top-left resume-template-wrapper" style={{ width: "795px" }}>
          ...
          <div>
            <div className="relative px-12 mb-3 text-2xl font-semibold" style={{ color: "#8675A9" }}>
              ...
              <div className="flex items-center">
                <div className="py-12">Ng Chun Liang <div style={{ display: "none" }}
                  className="mt-1 text-sm text-subtle"></div>
                </div>
                <Image src={myphoto} className="absolute right-12"
            ...
            <div className="flex px-12 py-3 space-x-3">
              ...
              <div className="grow"><span className="flex items-center space-x-1"><span
                ...
                style={{ width: "14px", height: "14px", color: "#8675A9" }}></span> <span
                  className="no-underline">ngchunliangy@gmail.com</span></span><span
                    className="flex items-center space-x-1"><span className="jlu-icon jlu-icon_call"
                      style={{ width: "14px", height: "14px", color: "#8675A9" }}></span> <span className="no-underline">+65
                        8433 2042</span></span><span className="flex items-center"><span
                          className="jlu-icon jlu-icon_location_on mr-1"
                          style={{ width: "14px", height: "14px", color: "#8675A9" }}></span><span>3
                            Ghim Moh Road #10-278 Singapore 270003.</span><span style={{ display: "none" }}>,
                  </span><span style={{ display: "none" }}>,
                  </span></span><a className="flex items-center space-x-1 no-underline"
                    href="https://www.linkedin.com/in/ng-chun-liang-09142528a" target="_blank"><span
                      className="jlu-icon jlu-icon_linkedin"
                      style={{ width: "14px", height: "14px", color: "#8675A9" }}></span>
                  <span>www.linkedin.com/in/ng-chun-liang-09142528a</span></a>
              </div>
            </div>
          </div>
